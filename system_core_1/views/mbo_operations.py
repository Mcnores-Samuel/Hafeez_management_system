...
def add_note_to_contract(request):
  ...
  if (request.method == 'POST' and request.user.is_authenticated and
    ...
    payload = {'head': 'Contract Note', 'body': 'Hello Team!, Note added to contract {}, IMEI: {}.\n{}'.format(
      contract_data.contract, contract_data.device_imei, note), 'icon': 'https://raw.githubusercontent.com/Mcnores-Samuel/Hafeez_management_system/main/system_core_1/static/images/logo.png',
